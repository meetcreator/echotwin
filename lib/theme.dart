...
/// Calm, premium color palette for voice-first decision companion
/// Deep indigo for trust and clarity, warm accents for human connection
class LightModeColors {
  // Primary: Deep indigo for intelligence and calm
  static const lightPrimary = Color(0xFF4A5FC1);
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFE0E5F8);
  static const lightOnPrimaryContainer = Color(0xFF1A237E);

  // Secondary: Warm amber for human warmth
  static const lightSecondary = Color(0xFFE89B3C);
  ...
  // Surface and background: Clean, minimal
...
/// Dark mode colors - calm and immersive
class DarkModeColors {
  // Primary: Soft indigo glow
  static const darkPrimary = Color(0xFF6F7BF7);
  static const darkOnPrimary = Color(0xFF1A237E);
  static const darkPrimaryContainer = Color(0xFF3949AB);
  static const darkOnPrimaryContainer = Color(0xFFE0E5F8);

  // Secondary: Warm amber
  static const darkSecondary = Color(0xFFFFB84D);
  static const darkOnSecondary = Color(0xFF2D1B00);
  ...
  // Surface and background: Deep, calm
  ...
  static const darkOnSurfaceVariant = Color(0xFFB8BFCC);
